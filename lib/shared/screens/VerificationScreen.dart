          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 25),
                Text('Please fill verification code that have been sent to your mobile phone', style: secondaryTextStyle(size: 16, color: appTextColorSecondary.withOpacity(0.7))),
                SizedBox(height: 70),
                Row(
                ...
                Align(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      SizedBox(height: 20),
                      Text('RESEND', style: boldTextStyle(color: appColorPrimary)),
                    ],
                  ),
                )
              ],
